import { getInvestorsSection } from "../actions";
...
export default async function InvestorsPage() {
    const investorsSection = await getInvestorsSection();
    return <InvestorsClient initialData={investorsSection ? serialize(investorsSection) : null} />;
}
